											...
											<div class="col-sm-12">
												<div class="card">
													<div class="card-block">
														<h4 class="sub-title">Gráficos do Sistema</h4>
...
var myChart = new Chart(document.getElementById('myChart'));/*Criando o gráfico apenas*/
...
function gerarGrafico() {
			...
			myChart = new Chart(
				    document.getElementById('myChart'),
				    {
						  ...
						  data: {
							  labels: json.perfils,
							  datasets: [{
							    label: 'Gráfico de Média Salarial por Função',
	...
	var urlAction = documnt.getElementById('formUser').action;
	var dataInicial = document.getElementById('dataInicial').value;
	var dataFinal = document.getElementById('dataFinal').value;
